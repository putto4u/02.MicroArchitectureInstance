...
acl "trusted" {
        ...
        192.168.10.0/24;   // 내부 사설 네트워크 대역(192.168.1.1 ~ 192.168.1.254)의 질의 허용
};
...
sudo cp /etc/bind/zones.rfc1918  /etc/bind/named.conf.local
sudo nano /etc/bind/named.conf.local  또는 sudo vi /etc/bind/named.conf.local
